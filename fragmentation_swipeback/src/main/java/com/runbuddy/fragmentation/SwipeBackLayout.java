...
import com.runbuddy.fragmentation_swipeback.SwipeBackActivity;
import com.runbuddy.fragmentation_swipeback.SwipeBackFragment;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    private void init() {
        ...
        setShadow(com.runbuddy.fragmentation_swipeback.R.drawable.shadow_left, EDGE_LEFT);
    ...
    public void setEdgeOrientation(int orientation) {
        ...
        if (orientation == EDGE_RIGHT || orientation == EDGE_ALL) {
            setShadow(com.runbuddy.fragmentation_swipeback.R.drawable.shadow_right, EDGE_RIGHT);
        }
    }
